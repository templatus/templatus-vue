...
assets by path js/*.js 150 KiB
  ...
  asset js/application-fcff66d2d63950b9f39f.js 15.9 KiB [emitted] [immutable] [minimized] (name: application) 3 related assets
...
Entrypoint application 167 KiB (229 KiB) = js/runtime-218550da3001279e7e74.js 1.46 KiB js/395-168ccf7539c47b283541.js 132 KiB css/application-1fdc0b43.css 17.3 KiB js/application-fcff66d2d63950b9f39f.js 15.9 KiB 6 auxiliary assets
orphan modules 395 KiB (javascript) 997 bytes (runtime) [orphan] 333 modules
runtime modules 3.47 KiB 7 modules
built modules 788 KiB (javascript) 2.33 KiB (asset) 27.6 KiB (css/mini-extract) [built]
...
webpack 5.65.0 compiled successfully in 6857 ms
```
