...
assets by path js/*.js 177 KiB
  asset js/550-4d2266e8a61d43b4e5a6.js 158 KiB [emitted] [immutable] [minimized] (id hint: vendors) 4 related assets
...
Entrypoint application 194 KiB (268 KiB) = js/runtime-218550da3001279e7e74.js 1.46 KiB js/550-4d2266e8a61d43b4e5a6.js 158 KiB css/application-0df3626d.css 17.5 KiB js/application-678a9d42b9af84e381fa.js 16.9 KiB 6 auxiliary assets
...
built modules 934 KiB (javascript) 2.33 KiB (asset) 27.8 KiB (css/mini-extract) [built]
  ...
  modules by path ./app/packs/ 31.1 KiB (javascript) 2.33 KiB (asset) 27.8 KiB (css/mini-extract)
...
webpack 5.57.1 compiled successfully in 6947 ms
```
