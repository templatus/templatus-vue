...
assets by path js/*.js 177 KiB
  asset js/550-5ae2733a7e284544a4de.js 158 KiB [emitted] [immutable] [minimized] (id hint: vendors) 4 related assets
  asset js/application-7ddeafbc968258aa8a34.js 16.9 KiB [emitted] [immutable] [minimized] (name: application) 3 related assets
  asset js/runtime-218550da3001279e7e74.js 1.46 KiB [emitted] [immutable] [minimized] (name: runtime) 3 related assets
asset css/application-e365cbfc.css 17.4 KiB [emitted] [immutable] [minimized] (name: application) 3 related assets
asset manifest.json 2.94 KiB [emitted] 2 related assets
Entrypoint application 194 KiB (266 KiB) = js/runtime-218550da3001279e7e74.js 1.46 KiB js/550-5ae2733a7e284544a4de.js 158 KiB css/application-e365cbfc.css 17.4 KiB js/application-7ddeafbc968258aa8a34.js 16.9 KiB 6 auxiliary assets
...
built modules 933 KiB (javascript) 2.33 KiB (asset) 27.7 KiB (css/mini-extract) [built]
  modules by path ./node_modules/ 902 KiB
    modules by path ./node_modules/@vue/ 422 KiB 4 modules
  ...
  modules by path ./app/packs/ 31.1 KiB (javascript) 2.33 KiB (asset) 27.7 KiB (css/mini-extract)
...
webpack 5.56.0 compiled successfully in 7563 ms
```
