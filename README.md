...
assets by path js/*.js 146 KiB
  asset js/382-4bd740b6cc4f2303dede.js 127 KiB [emitted] [immutable] [minimized] (id hint: vendors) 4 related assets
...
Entrypoint application 163 KiB (226 KiB) = js/runtime-476cc9f35402e4fdec05.js 1.42 KiB js/382-4bd740b6cc4f2303dede.js 127 KiB css/application-53c4176e.css 17.8 KiB js/application-3b5ccf3e5cded0be08fe.js 17.7 KiB 6 auxiliary assets
orphan modules 185 KiB [orphan] 296 modules
runtime modules 3.39 KiB 7 modules
built modules 732 KiB (javascript) 2.33 KiB (asset) 27.6 KiB (css/mini-extract) [built]
  ...
  modules by path ./app/packs/ 33.4 KiB (javascript) 2.33 KiB (asset) 27.6 KiB (css/mini-extract)
...
webpack 5.45.1 compiled successfully in 5852 ms
```
